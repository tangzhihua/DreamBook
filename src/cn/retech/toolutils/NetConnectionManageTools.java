...
public class NetConnectionManageTools {
	...
	private void checkApn() {
		...
		final Cursor cursor = MyApplication.getApplication().getContentResolver().query(PREFERRED_APN_URI, new String[] { "_id", "apn", "proxy", "port" }, null, null, null);
	...
	public String toString() {
		return "NetConnectionManageTools [isNetAvailable=" + isNetAvailable + ", mApn=" + mApn + ", mProxy=" + mProxy + ", mPort=" + mPort + ", availableNetTypeEnum=" + availableNetTypeEnum + ", isWapNetwork=" + isWapNetwork + "]";
	}
