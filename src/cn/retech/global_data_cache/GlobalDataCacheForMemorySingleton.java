...
public enum GlobalDataCacheForMemorySingleton {
	...
	private String publicUserNameString = "public";

	private String publicUserPasswordString = "pwpublic";

	public String getPublicUserNameString() {
		return publicUserNameString;
	}

	public String getPublicUserPasswordString() {
		return publicUserPasswordString;
	}
}
